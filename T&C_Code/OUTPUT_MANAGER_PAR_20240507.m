...
vars_avg = {'Pr_tg','Ta_tg','Ws_tg','Ds_tg','ea_tg','N_tg','Pre_tg',...
    ...
    'LAI_tg','NDVI_tg','NPP_tg','RA_tg','GPP_tg'};
...
if toutp==2
    ...
    V_spatial_tm1 = sum(Vtm1,2);
    Vice_spatial_tm1 = sum(Vicetm1,2); 
    SWE_spatial_tm1 = SWEtm1;
    ICE_spatial_tm1 = ICEtm1;
    FROCK_spatial_tm1 = FROCKtm1;
    WAT_spatial_tm1 = WATtm1;
    In_spatial_tm1 = In_tm1;
    In_spatial_tm1 =  sum(In_Htm1,2) + sum(In_Ltm1,2) + SP_wctm1 + In_SWEtm1  + In_urbtm1 + In_rocktm1 + IP_wctm1;
