...
if toutp==2
    ...
    q_runon_spatialtm1 = q_runontm1;
    Q_channel_spatialtm1 = Q_channeltm1;
    ...
    q_runon_spatialtm1 = ((toutp-2)*q_runon_spatialtm1 +  q_runontm1)/(toutp-1) ;
    Q_channel_spatialtm1 = ((toutp-2)*Q_channel_spatialtm1 +  Q_channeltm1)/(toutp-1) ;
...
if  length(intersect(t,tstore))==1 ||  t==N_time_step
    ...
    save(Title_save,'DTM','cellsize','xllcorner','yllcorner','x_cell','y_cell','m_cell','n_cell','Pr_spatial',...
        ...
        'q_runon_spatialtm1','Q_channel_spatialtm1');
    %%%%%%%%%%
    toutp = 1;
    %%%%%%%%%%
end
