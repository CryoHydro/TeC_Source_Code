...
function[Ts,Pr_sno,Pr_liq,Ws_under,Csno,Cice,Cfol_H,Cfol_L,CLitter,NDVI,rb_H,rb_L,rs_sunH,rs_sunL,rs_shdH,rs_shdL,r_litter,...
    ...
    min_SPD,OPT_VegSnow,OPT_SoilTemp,OPT_PlantHydr,Opt_CR,Opt_ST,Opt_ST2,OPT_STh,OPT_FR_SOIL,OPT_PH,OPT_Pr_Part,hSTL)
%%% INPUTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% OUTPUTS
%
...
[Pr_sno,Pr_liq]=Precipitation_partition(Pr,Ta,TminS,TmaxS,ea,Pre,OPT_Pr_Part);
%%% Throughfall
