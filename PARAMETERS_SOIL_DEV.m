...
zatm = max(zatm);
%% SOIL
SPAR=OPT_PARAM_vals.SPAR; %%% SOIL PARAMETER TYPE (1-VanGenuchten 2-Saxton-Rawls)
%%%%
...
%%%%%%%%%%%%%%%% Matric Potential
Kfc = OPT_PARAM_vals.Kfc; %% [mm/h]
Phy = OPT_PARAM_vals.Phy; %% [kPa]
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%
...
%================= OTHER PARAMETER ================================
%Interception
In_max_urb=OPT_PARAM_vals.In_max_urb; % [mm] maximum interception capacity in urban
In_max_rock=OPT_PARAM_vals.In_max_rock; %% [mm] Maximum interception capacity in rocks
...
Ice_wc_sp = OPT_PARAM_vals.Ice_wc_sp; %% [-] Specific Maximum water content ice
ros_Ice_thr = OPT_PARAM_vals.ros_Ice_thr; %% [kg/m^3] Density Thrshold to transform snow into ice
WatFreez_Th = OPT_PARAM_vals.WatFreez_Th; %% [?C] Threshold for freezing lake water
dz_ice = OPT_PARAM_vals.dz_ice; %% [mm / h] Water Freezing Layer progression without snow-layer
...
CASE_ROOT = OPT_PARAM_vals.CASE_ROOT; % Type of Root Profile
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Kct=OPT_PARAM_vals.Kct; %%% Factor Vegetation Cover --- for throughfall
% Interception Parameter
gcI=OPT_PARAM_vals.gcI;  %%% [1/mm]
KcI=OPT_PARAM_vals.KcI; %%%% [mm] -- Mahfouf and Jacquemin 1989
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%% Interception Parameter
Sp_SN_In=OPT_PARAM_vals.Sp_SN_In; %% [mm/LAI]
...
%--------------------------------------------------------------------------
Sllit = OPT_PARAM_vals.Sllit; % Litter Specific Leaf area [m2 Litter / kg DM]
...
%% Debris parameters
Deb_Par.alb= OPT_PARAM_vals.Deb_Par_alb; 
Deb_Par.e_sur =  OPT_PARAM_vals.Deb_Par_e_sur;
Deb_Par.lan = OPT_PARAM_vals.Deb_Par_lan; 
Deb_Par.rho = OPT_PARAM_vals.Deb_Par_rho;  % [kg/m^3]
Deb_Par.cs = OPT_PARAM_vals.Deb_Par_cs;  % [J/kg K]
Deb_Par.zom = OPT_PARAM_vals.Deb_Par_zom; 
